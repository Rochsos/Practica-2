...
public class ListaUsuarios {
	...
	// Creamos la variable lista que será estatica para que no la tengamos que
	// instanciar en otra clase
	...
	// voy a crear un metodo que va a ser para eliminar objetos
